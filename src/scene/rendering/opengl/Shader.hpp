...
namespace KCore::opengl {
    ...
    public:
        ...
        explicit Shader(const std::string& name) : Id(glCreateProgram()), Name(name) {
            Tag = "KRen - Shader program [" + (name.empty() ? std::to_string(Id) : name) + "]";
        ...
        void addShaderPairFromPath(const std::string& path) {
            ...
            std::string additional = "| Shader id: " + std::to_string(vsId) + " and Shader id: " + std::to_string(fsId);
        }
        ...
        void addVertexShader(const std::string& source, ShaderSourceType sourceType = Text) {
            ...
            std::string additional = "| Shader id: " + std::to_string(id);

            //kren::engine::log(Tag, "Vertex Shader declared successfully " + additional, info);
        }
        ...
        void addFragmentShader(const std::string& source, ShaderSourceType sourceType = Text) {
            ...
            //kren::engine::log(Tag, "Fragment Shader declared successfully " + additional, info);
        }
        ...
        void build() {
            ...
            //kren::engine::log(Tag, "Shader program created successfully", info);
        };
